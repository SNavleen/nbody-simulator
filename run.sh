...
# mpirun -np 2 ./x.project 1000 500 500 3600 10 0.016 2550 1440 video
# mpirun -np 4 ./x.project 2000 1000 1000 3600 10 0.016 2550 1440 video
# mpirun -np 8 ./x.project 1000 4000 3000 3600 10 0.016 2550 1440 video
# mpirun -np 16 ./x.project 6000 4000 5000 3600 10 0.016 2550 1440 video
# mpirun -np 2 ./x.project 12000 10000 10000 3600 10 0.016 2550 1440 video
